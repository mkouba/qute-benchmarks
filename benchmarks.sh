...
QUTE_VERSIONS="2.7.6.Final 2.13.3.Final 2.14.0.Final 999-SNAPSHOT";
...
if [ "$1" ]; then
    ...
    BENCHMARKS="Hello|HelloParser|Loop|Loop50|IfSimple|IfComplexCondition|NameResolver|IncludeSimple|When"
fi
