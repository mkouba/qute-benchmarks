...
public abstract class BenchmarkBase {
    ...
    public void setup() throws Exception {
        ...
        builder.addLocator(new TemplateLocator() {
            ...
            public Optional<TemplateLocation> locate(String id) {
                InputStream in = BenchmarkBase.class.getResourceAsStream("/templates/" + id);
                if (in == null) {
    ...
    ValueResolver createResolver(String resolverClassName)
        ...
        try {
            ...
            if (cl == null) {
                cl = BenchmarkBase.class.getClassLoader();
            }
    ...
    static Index index(Class<?>... classes) throws IOException {
        ...
        for (Class<?> clazz : classes) {
            try (InputStream stream = BenchmarkBase.class.getClassLoader()
